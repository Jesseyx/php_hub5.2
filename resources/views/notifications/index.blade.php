                            ...
                            @if (count($notification->topic))
                                <div class="avatar pull-left">
                                    <a href="{{ route('users.show', [$notification->from_user_id]) }}">
                                        <img class="media-object img-thumbnail avatar" src="{{ $notification->fromUser->present()->gravatar }}" alt="{{ $notification->fromUser->name }}" style="width: 38px; height: 38px;">
                                    </a>
                                </div>

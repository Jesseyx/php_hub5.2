                        ...
                        <ul class="list-inline">
                            ...
                            @if ($user->weibo_link)
                                <li class="popover-with-html" data-content="{{ $user->weibo_name }}">
                                    <a class="weibo" href="{{ $user->weibo_link }}" target="_blank" rel="nofollow"><i class="fa fa-weibo"></i> Weibo
                                    </a>
                                </li>
                            @endif
                            ...
                            @if ($user->twitter_account)
                                <li class="popover-with-html" data-content="{{ $user->twitter_account }}">
                                    <a class="twitter" href="https://twitter.com/{{ $user->twitter_account }}" target="_blank" rel="nofollow"><i class="fa fa-twitter"></i> Twitter
                                    </a>
                                </li>
                            @endif
                            ...
                            @if ($user->linkedin)
                                <li class="popover-with-html" data-content="点击查看 LinkedIn 个人资料">
                                    <a class="linkedin" href="{{ $user->linkedin }}" target="_blank" rel="nofollow"><i class="fa fa-linkedin"></i> LinkedIn
                                    </a>
                                </li>
                            @endif

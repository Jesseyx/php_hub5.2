<ul class="pull-right list-inline remove-margin-bottom topic-filter">
    <li>
        <a {!! app(App\Topic::class)->present()->topicFilter('recent') !!}>
    ...
    <li>
        <a {!! app(App\Topic::class)->present()->topicFilter('excellent') !!}>
    ...
    <li>
        <a {!! app(App\Topic::class)->present()->topicFilter('vote') !!}>
    ...
    <li>
        <a {!! app(App\Topic::class)->present()->topicFilter('noreply') !!}>
